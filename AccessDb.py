...
def AccessDatabase(db_loc, compliance_db_loc, compliance_data_sheet_name,
    ...
    db_root = Path(db_loc)
    compliance_sheet = load_sheet(db_root / compliance_db_loc, compliance_data_sheet_name)
    outcomes_sheet = load_sheet(db_root / outcome_db_loc, outcome_data_sheet_name)

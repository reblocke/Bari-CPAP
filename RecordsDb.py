...
class PatientRecord:
    ...
    def calc_ewl_list(self, weights):
        ...
        '''
        if weights is None or len(weights) == 0 or weights[0] is None or self.Height_DOS is None or self.Sex is None:
    ...
    def maxWeightLoss(self):
        ...
        if len(self.Weights) == 0 or self.Weights[0] is None:
            return None
        else:
            min = self.Weights[0]
